...
public class CampusPathsTest { // Rename to the name of your "main" class
	...
	@Test
	public void testShortestPathBothNumbers() throws IOException {
		runTest("test3");
	}
	
	@Test
	public void testShortestPathOneNumber() throws IOException {
		runTest("test4");
	}
	
	@Test 
	public void testShortestPathBothWords() throws IOException {
		runTest("test5");
	}
	...
	@Test 
	public void testTwoUnknowns() throws IOException {
		runTest("test9");
	}
	
	@Test
	public void testAllDirections() throws IOException {
		runTest("test10");
	}
